function[] = ...
    ...
    (Graph_Parameter,SSlist,size_ratio)
...
%   size_ratio: alpha is a free parameters that controls the 
%exponential growth of the size of the balls. It is employed
