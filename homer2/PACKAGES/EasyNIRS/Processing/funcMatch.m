function score = funcMatch(f1,f2)

f1.funcArgIn = parseProcessFuncArgsIn(f1.funcArgIn);
f2.funcArgIn = parseProcessFuncArgsIn(f2.funcArgIn);
f1.funcArgOut = parseProcessFuncArgsOut(f1.funcArgOut);
f2.funcArgOut = parseProcessFuncArgsOut(f2.funcArgOut);
